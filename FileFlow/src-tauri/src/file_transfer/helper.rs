...
use magic_wormhole::{transfer::{AppVersion, APPID}, transit::{RelayHint, RelayHintParseError}, AppConfig};

use super::types::serverconfig::ServerConfig;


//generate default relay hints
pub fn gen_relay_hints(server_config: &ServerConfig) -> Result<Vec<RelayHint>,RelayHintParseError>{
